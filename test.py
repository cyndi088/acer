...
# rsp = db['wired_articles'].find().sort([("stamp_time", -1)]).limit(1)
# print(rsp[0]['stamp_time'])
rsp = db['wired_articles_test'].find_one({"title": "The Deal to Save ZTE Won't Resolve hina Tensions"})
print(rsp==None)
